        ...
        {!sent ? (
          <>
            ...
            <div className="modern-form-group">
              ...
              <input type="email" placeholder="you@example.com"
                ...
                className="modern-input" autoFocus />
            </div>
            <div className="forgot-modal-actions">
              <button className="forgot-cancel-btn" onClick={onClose}>Cancel</button>
              <button className="forgot-send-btn" onClick={handleSend} disabled={loading}>
          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} style={{ textAlign: 'center' }}>
            <div style={{
              ...
              margin: '0 auto 16px', boxShadow: '0 6px 20px rgba(59,130,246,0.45)',
            }}>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="modern-form">
            ...
            <div className="modern-form-group">
              ...
              <input type="text" placeholder="username or you@example.com" value={formData.username}
            ...
            <div className="modern-form-group">
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{ paddingRight: '42px' }} autoComplete="current-password"
                />
          ...
          <p className="auth-privacy">
            ...
            <button type="button" className="auth-privacy-link">Terms of Service</button> and{' '}
            <button type="button" className="auth-privacy-link">Privacy Policy</button>.
          </p>
        </motion.div>
      </div>
      <AnimatePresence>
